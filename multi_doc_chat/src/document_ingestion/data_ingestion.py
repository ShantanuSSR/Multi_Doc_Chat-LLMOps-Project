...
class ChatIngestor:
    def __init__( self,
        temp_base: str = "data",  # This is the temporary directory from where the ChatIngestor will fetch the documents
        faiss_base: str = "faiss_index", # This is the directory where the FAISS index will be stored
        use_session_dirs: bool = True, # This is the flag to use session directories
        session_id: Optional[str] = None, # This is the session ID
    ):
        try:
    ...
    def built_retriver( self,
        ...
        *,
        ...
        try:
            paths = save_uploaded_files(uploaded_files, self.temp_dir)  # for getting session based data of the user and saving it in the temporary directory
